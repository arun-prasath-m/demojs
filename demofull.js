...
function FormFacade(data)
{
    ...
    this.addLinkTag = function(lnkurl)
    {
        ...
        var version = this.data.devEnv?new Date().getTime():95;
    ...
    this.renderSignature = function()
    {
        ...
        signatures.forEach(function(signature){
            ...
            if(!signature.dataset.esignAdded && canvas){
                ...
                if(signaturePad && signaturePad.isEmpty() && imageUrl && typeof imageUrl === 'string') {
                    if(curr.data.devEnv)
...
window.formFacade = new FormFacade({"request":{"params":{"publishId":"1FAIpQLSd1ADWEf0M5RYxQqZFYZcTiGBA4H0b7TmxGfA7k_MmIjIbFzw","target":"wordpress","userId":"100066911282161708792"},"query":{}}});
